...
DO $$ BEGIN ALTER TABLE "MenuPlanItem" ADD PRIMARY KEY ("id"); EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "Pembelian" ADD PRIMARY KEY ("id"); EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "PembelianItem" ADD PRIMARY KEY ("id"); EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "Verifikasi" ADD PRIMARY KEY ("id"); EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "Stok" ADD PRIMARY KEY ("id"); EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "StokBatch" ADD PRIMARY KEY ("id"); EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "Opname" ADD PRIMARY KEY ("id"); EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "OpnameItem" ADD PRIMARY KEY ("id"); EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "BarangMasuk" ADD PRIMARY KEY ("id"); EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "BarangMasukItem" ADD PRIMARY KEY ("id"); EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "BarangKeluar" ADD PRIMARY KEY ("id"); EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "BarangKeluarItem" ADD PRIMARY KEY ("id"); EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "Waste" ADD PRIMARY KEY ("id"); EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "WasteItem" ADD PRIMARY KEY ("id"); EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "AuditLog" ADD PRIMARY KEY ("id"); EXCEPTION WHEN OTHERS THEN null; END $$;

-- 4. FOREIGN KEYS (safe creation)
DO $$ BEGIN ALTER TABLE "Barang" ADD CONSTRAINT "Barang_kategoriId_fkey" FOREIGN KEY ("kategoriId") REFERENCES "KategoriBarang"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "Barang" ADD CONSTRAINT "Barang_satuanId_fkey" FOREIGN KEY ("satuanId") REFERENCES "Satuan"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "Resep" ADD CONSTRAINT "Resep_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "ResepBahan" ADD CONSTRAINT "ResepBahan_resepId_fkey" FOREIGN KEY ("resepId") REFERENCES "Resep"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "ResepBahan" ADD CONSTRAINT "ResepBahan_barangId_fkey" FOREIGN KEY ("barangId") REFERENCES "Barang"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "MenuPlan" ADD CONSTRAINT "MenuPlan_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "MenuPlanItem" ADD CONSTRAINT "MenuPlanItem_menuPlanId_fkey" FOREIGN KEY ("menuPlanId") REFERENCES "MenuPlan"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "MenuPlanItem" ADD CONSTRAINT "MenuPlanItem_resepId_fkey" FOREIGN KEY ("resepId") REFERENCES "Resep"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "Pembelian" ADD CONSTRAINT "Pembelian_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "PembelianItem" ADD CONSTRAINT "PembelianItem_pembelianId_fkey" FOREIGN KEY ("pembelianId") REFERENCES "Pembelian"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "PembelianItem" ADD CONSTRAINT "PembelianItem_barangId_fkey" FOREIGN KEY ("barangId") REFERENCES "Barang"("id") ON DELETE SET NULL ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "Verifikasi" ADD CONSTRAINT "Verifikasi_pembelianId_fkey" FOREIGN KEY ("pembelianId") REFERENCES "Pembelian"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "Verifikasi" ADD CONSTRAINT "Verifikasi_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "Stok" ADD CONSTRAINT "Stok_barangId_fkey" FOREIGN KEY ("barangId") REFERENCES "Barang"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "StokBatch" ADD CONSTRAINT "StokBatch_stokId_fkey" FOREIGN KEY ("stokId") REFERENCES "Stok"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "Opname" ADD CONSTRAINT "Opname_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "OpnameItem" ADD CONSTRAINT "OpnameItem_opnameId_fkey" FOREIGN KEY ("opnameId") REFERENCES "Opname"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "OpnameItem" ADD CONSTRAINT "OpnameItem_barangId_fkey" FOREIGN KEY ("barangId") REFERENCES "Barang"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "BarangMasuk" ADD CONSTRAINT "BarangMasuk_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "BarangMasuk" ADD CONSTRAINT "BarangMasuk_pembelianId_fkey" FOREIGN KEY ("pembelianId") REFERENCES "Pembelian"("id") ON DELETE SET NULL ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "BarangMasukItem" ADD CONSTRAINT "BarangMasukItem_barangMasukId_fkey" FOREIGN KEY ("barangMasukId") REFERENCES "BarangMasuk"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "BarangMasukItem" ADD CONSTRAINT "BarangMasukItem_barangId_fkey" FOREIGN KEY ("barangId") REFERENCES "Barang"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "BarangKeluar" ADD CONSTRAINT "BarangKeluar_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "BarangKeluarItem" ADD CONSTRAINT "BarangKeluarItem_barangKeluarId_fkey" FOREIGN KEY ("barangKeluarId") REFERENCES "BarangKeluar"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "BarangKeluarItem" ADD CONSTRAINT "BarangKeluarItem_barangId_fkey" FOREIGN KEY ("barangId") REFERENCES "Barang"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "Waste" ADD CONSTRAINT "Waste_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "WasteItem" ADD CONSTRAINT "WasteItem_wasteId_fkey" FOREIGN KEY ("wasteId") REFERENCES "Waste"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "WasteItem" ADD CONSTRAINT "WasteItem_barangId_fkey" FOREIGN KEY ("barangId") REFERENCES "Barang"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
DO $$ BEGIN ALTER TABLE "AuditLog" ADD CONSTRAINT "AuditLog_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE; EXCEPTION WHEN OTHERS THEN null; END $$;
